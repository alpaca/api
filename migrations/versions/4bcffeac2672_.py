...
Revision ID: 4bcffeac2672
Revises: None
Create Date: 2014-04-23 17:00:03.054889

"""

# revision identifiers, used by Alembic.
revision = '4bcffeac2672'
down_revision = None
...
def upgrade():
    ...
    sa.Column('page_id', sa.BigInteger(), nullable=False),
    sa.PrimaryKeyConstraint('category', 'page_id'),
    ...
    sa.UniqueConstraint('uid1'),
    sa.UniqueConstraint('uid2')
    )
